...
class EncryptData:
    ...
    def encrypt(self):
        ...
        print(Fore.GREEN + '-------------------------------------------------------------\n', Style.RESET_ALL)
        print(Fore.MAGENTA + '**********************************************************|FIN-ENCODE|************************************************************', Style.RESET_ALL)
    def avalanche(self):
        new_plain_text = self._change_bit(self.plain_text)
        print(Fore.CYAN, "Original plain text: ", Style.RESET_ALL, self.plain_text.hex(), "\n")
        print(Fore.CYAN, "New plain text modify one bit: ", Style.RESET_ALL, new_plain_text.hex(), "\n")
        ...
        print(Fore.GREEN + '--------------------------------------------------------------------------------------------------------------------------')
        print(Fore.GREEN + '------------------------------------------------------------HEX-|AVALANCHE|-----------------------------------------------\n',Style.RESET_ALL)
        ...
        print(Fore.GREEN + '-------------------------------------------------------------------------')
        print(Fore.GREEN + '----------------------BASE64 - UTF-8-|AVALANCHE|-------------------------\n', Style.RESET_ALL)
        print(base64_utf8,Fore.RED + " --------> ",Style.RESET_ALL,base64_utf8_2)
        print(Fore.GREEN + '-------------------------------------------------------------------------', Style.RESET_ALL)
        print(Fore.MAGENTA + '********************************************************************|FIN AVALANCHE|****************************************************\n', Style.RESET_ALL)     
